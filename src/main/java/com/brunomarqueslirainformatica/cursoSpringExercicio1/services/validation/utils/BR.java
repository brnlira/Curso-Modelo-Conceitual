package com.brunomarqueslirainformatica.cursoSpringExercicio1.services.validation.utils;

public class BR {

	// CPF
	private static final int[] wightSsn = { 11, 10, 9, 8, 7, 6, 5, 4, 3, 2 };
    ...
    */
	...
	public static boolean isValidCPF(final String ssn) {
		...
		final Integer digit1 = calculate(ssn.substring(0, 9), wightSsn);
		final Integer digit2 = calculate(ssn.substring(0, 9) + digit1, wightSsn);
